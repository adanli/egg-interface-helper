...
public class ApiController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "paramsVO", value = "params参数", dataType = "IhParamsVO", paramType = "query", required = true),
            @ApiImplicitParam(name = "headerVO", value = "headers参数", dataType = "IhHeaderVO", paramType = "query", required = true),
            @ApiImplicitParam(name = "bodyVO", value = "body参数", dataType = "IhBodyVO", paramType = "query", required = true),
            @ApiImplicitParam(name = "responseVO", value = "返回值类", dataType = "IhResponseVO", paramType = "query", required = true)
    })
    ...
    @ApiOperation(notes = "/class/{classId}", value = "根据类主键删除类")
    ...
    @ApiOperation(notes = "/interface/{interfaceId}", value = "根据类主键删除类")
